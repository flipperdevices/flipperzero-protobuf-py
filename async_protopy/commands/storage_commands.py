...
class StorageUntarRequestCommand(BaseCommand):
    def __init__(self, tar_path: str, out_path: str):
        super().__init__(
            method_name='storage_tar_extract_request',
            proto_class=storage_pb2.TarExtractRequest,
        )
    ...
    def create_message(self, command_id):
        ...
        cmd_data.tar_path = self.tar_path
        cmd_data.out_path = self.out_path
