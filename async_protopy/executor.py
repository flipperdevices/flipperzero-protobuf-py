...
class FlipperProtoExecutor:
    ...
    def update_next_command_id(self) -> int:
        self.command_id += 1
        return self.command_id

    async def execute_command(
        self, command: BaseCommand, command_id: int = None
    ) -> AsyncGenerator:  # TODO command_id for writing without changing command_id
